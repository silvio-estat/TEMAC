...
| :--- | :--- | :--- |
| **Fase 1 — Identificação** | Deduplicação por título normalizado | 4.976 → 3.832 únicos (1.144 duplicatas marcadas) |
| **Fase 2 — Triagem por Impacto** | Score ≥ 5: autores âncora (CI-2) + "data lake/lakehouse" no título (CI-1 proxy) | 215 registros |
| **Fase 3 — Triagem Temática** | Score ≥ 7: + metadados/governança (CI-3) + Decision/ML/C2 (CI-4), – CE-1 (Big Data genérico), – CE-3 (medicina/agro/sensoriamento) | 52 registros para download |